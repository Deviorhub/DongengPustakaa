  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 justify-center items-center mt-[95px] lg:mt-[150px]">
        <h1 className="text-white text-center text-5xl lg:text-6xl font-bold max-w-5xl mx-auto lg:mb-3">
          Temukan Kisah Menakjubkan di Koleksi Buku Cerita Terbaru Kami!
        </h1>
        <p className="leading-6 text-sm text-white text-center text-[18px] max-w-3xl mx-auto lg:mb-4">
